                  ...
                  <div className='flex items-center justify-start mt-3'>
                      ...
                      <>
                        ...
                        <div className="font-light text-xs leading-6 ml-3">
                          <span className='mr-1 text-author font-normal'>{post.author.name}</span>
                    ...
                    <div className='mt-3 text-xs leading-5.5 font-extralight flex space-x-2'>
                      {post?.tags && post.tags.map(item=> ( <div className='px-2 h-5.5 rounded-full cursor-pointer bg-sophon text-white hover: hover:bg-opacity-90' key={item}>{item}</div>))}
                    </div>
                </div>
                <div className='flex-grow-0'>
                  <img src={post.imageUrl} className='w-20 h-14 lg:w-32 lg:h-20 rounded-md hover:transition-all object-cover flex-1 flex-shrink'/>
                </div>
            </div>
      </div>
